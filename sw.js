...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=279',
  './vendor/react-dom.production.min.js?v=279',
  './vendor/xlsx.full.min.js?v=279',
  './vendor/pdf.min.js?v=279',
  './vendor/mammoth.browser.min.js?v=279',
  './src/constants.js?v=279',
  './src/helpers.js?v=279',
  './src/approval.js?v=279',
  './src/xlsx-styled.js?v=279',
  './src/ai.js?v=279',
  './src/ai_models.js?v=279',
  './src/config.js?v=279',
  './src/update.js?v=279',
  './src/qr.js?v=279',
  './src/sp.js?v=279',
  ...
  './src/db.js?v=279',
  './src/auth.js?v=279',
  './src/components/LoginPage.js?v=279',
  './src/components/RegisterPage.js?v=279',
  './src/components/CompanyDBPanel.js?v=279',
  './src/components/CeDefaultsPanel.js?v=279',
  './src/components/ShiftRatesPanel.js?v=279',
  './src/components/FbSetupPanel.js?v=279',
  './src/components/LocalToSPSync.js?v=279',
  './src/components/ChangePasswordModal.js?v=279',
  './src/components/UpdatePublisher.js?v=279',
  './src/components/AdminPanel.js?v=279',
  './src/components/RceChecklistCard.js?v=279',
  './src/components/ResTab.js?v=279',
  './src/App.js?v=279',
  './src/widgets.js?v=279',
  './src/tests.js?v=279',
  './src/ml_utils.js?v=279'
];
/* APP_END */
