...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=222',
  './vendor/react-dom.production.min.js?v=222',
  './vendor/xlsx.full.min.js?v=222',
  './vendor/pdf.min.js?v=222',
  './vendor/mammoth.browser.min.js?v=222',
  './src/constants.js?v=222',
  './src/helpers.js?v=222',
  './src/approval.js?v=222',
  './src/xlsx-styled.js?v=222',
  './src/ai.js?v=222',
  './src/ai_models.js?v=222',
  './src/config.js?v=222',
  './src/update.js?v=222',
  './src/sp.js?v=222',
  './src/idb.js?v=222',
  './src/db.js?v=222',
  './src/auth.js?v=222',
  './src/components/LoginPage.js?v=222',
  './src/components/RegisterPage.js?v=222',
  './src/components/CompanyDBPanel.js?v=222',
  './src/components/CeDefaultsPanel.js?v=222',
  './src/components/ShiftRatesPanel.js?v=222',
  './src/components/FbSetupPanel.js?v=222',
  './src/components/LocalToSPSync.js?v=222',
  './src/components/ChangePasswordModal.js?v=222',
  './src/components/UpdatePublisher.js?v=222',
  './src/components/AdminPanel.js?v=222',
  './src/components/ResTab.js?v=222',
  './src/App.js?v=222',
  './src/widgets.js?v=222',
  './src/tests.js?v=222',
  './src/ml_utils.js?v=222'
];
/* APP_END */
