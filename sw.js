...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=244',
  './vendor/react-dom.production.min.js?v=244',
  './vendor/xlsx.full.min.js?v=244',
  './vendor/pdf.min.js?v=244',
  './vendor/mammoth.browser.min.js?v=244',
  './src/constants.js?v=244',
  './src/helpers.js?v=244',
  './src/approval.js?v=244',
  './src/xlsx-styled.js?v=244',
  './src/ai.js?v=244',
  './src/ai_models.js?v=244',
  './src/config.js?v=244',
  './src/update.js?v=244',
  './src/sp.js?v=244',
  './src/idb.js?v=244',
  './src/db.js?v=244',
  './src/auth.js?v=244',
  './src/components/LoginPage.js?v=244',
  './src/components/RegisterPage.js?v=244',
  './src/components/CompanyDBPanel.js?v=244',
  './src/components/CeDefaultsPanel.js?v=244',
  './src/components/ShiftRatesPanel.js?v=244',
  './src/components/FbSetupPanel.js?v=244',
  './src/components/LocalToSPSync.js?v=244',
  './src/components/ChangePasswordModal.js?v=244',
  './src/components/UpdatePublisher.js?v=244',
  './src/components/AdminPanel.js?v=244',
  './src/components/ResTab.js?v=244',
  './src/App.js?v=244',
  './src/widgets.js?v=244',
  './src/tests.js?v=244',
  './src/ml_utils.js?v=244'
];
/* APP_END */
