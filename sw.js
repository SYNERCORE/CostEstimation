...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=284',
  './vendor/react-dom.production.min.js?v=284',
  './vendor/xlsx.full.min.js?v=284',
  './vendor/pdf.min.js?v=284',
  './vendor/mammoth.browser.min.js?v=284',
  './src/constants.js?v=284',
  './src/helpers.js?v=284',
  './src/approval.js?v=284',
  './src/xlsx-styled.js?v=284',
  './src/ai.js?v=284',
  './src/ai_models.js?v=284',
  './src/config.js?v=284',
  './src/update.js?v=284',
  './src/qr.js?v=284',
  './src/sp.js?v=284',
  ...
  './src/db.js?v=284',
  './src/auth.js?v=284',
  './src/components/LoginPage.js?v=284',
  './src/components/RegisterPage.js?v=284',
  './src/components/CompanyDBPanel.js?v=284',
  './src/components/CeDefaultsPanel.js?v=284',
  './src/components/ShiftRatesPanel.js?v=284',
  './src/components/FbSetupPanel.js?v=284',
  './src/components/LocalToSPSync.js?v=284',
  './src/components/ChangePasswordModal.js?v=284',
  './src/components/UpdatePublisher.js?v=284',
  './src/components/AdminPanel.js?v=284',
  './src/components/RceChecklistCard.js?v=284',
  './src/components/ResTab.js?v=284',
  './src/App.js?v=284',
  './src/widgets.js?v=284',
  './src/tests.js?v=284',
  './src/ml_utils.js?v=284'
];
/* APP_END */
