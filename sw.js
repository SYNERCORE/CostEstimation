...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=171',
  './vendor/react-dom.production.min.js?v=171',
  './vendor/xlsx.full.min.js?v=171',
  './vendor/pdf.min.js?v=171',
  './vendor/mammoth.browser.min.js?v=171',
  './src/constants.js?v=171',
  './src/helpers.js?v=171',
  './src/xlsx-styled.js?v=171',
  './src/ai.js?v=171',
  './src/ai_models.js?v=171',
  './src/config.js?v=171',
  './src/update.js?v=171',
  './src/sp.js?v=171',
  './src/idb.js?v=171',
  './src/db.js?v=171',
  './src/auth.js?v=171',
  './src/components/LoginPage.js?v=171',
  './src/components/RegisterPage.js?v=171',
  './src/components/CompanyDBPanel.js?v=171',
  './src/components/CeDefaultsPanel.js?v=171',
  './src/components/FbSetupPanel.js?v=171',
  './src/components/LocalToSPSync.js?v=171',
  './src/components/ChangePasswordModal.js?v=171',
  './src/components/UpdatePublisher.js?v=171',
  './src/components/AdminPanel.js?v=171',
  './src/components/ResTab.js?v=171',
  './src/App.js?v=171',
  './src/widgets.js?v=171',
  './src/tests.js?v=171',
  './src/ml_utils.js?v=171'
];
/* APP_END */
