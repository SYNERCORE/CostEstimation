...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=224',
  './vendor/react-dom.production.min.js?v=224',
  './vendor/xlsx.full.min.js?v=224',
  './vendor/pdf.min.js?v=224',
  './vendor/mammoth.browser.min.js?v=224',
  './src/constants.js?v=224',
  './src/helpers.js?v=224',
  './src/approval.js?v=224',
  './src/xlsx-styled.js?v=224',
  './src/ai.js?v=224',
  './src/ai_models.js?v=224',
  './src/config.js?v=224',
  './src/update.js?v=224',
  './src/sp.js?v=224',
  './src/idb.js?v=224',
  './src/db.js?v=224',
  './src/auth.js?v=224',
  './src/components/LoginPage.js?v=224',
  './src/components/RegisterPage.js?v=224',
  './src/components/CompanyDBPanel.js?v=224',
  './src/components/CeDefaultsPanel.js?v=224',
  './src/components/ShiftRatesPanel.js?v=224',
  './src/components/FbSetupPanel.js?v=224',
  './src/components/LocalToSPSync.js?v=224',
  './src/components/ChangePasswordModal.js?v=224',
  './src/components/UpdatePublisher.js?v=224',
  './src/components/AdminPanel.js?v=224',
  './src/components/ResTab.js?v=224',
  './src/App.js?v=224',
  './src/widgets.js?v=224',
  './src/tests.js?v=224',
  './src/ml_utils.js?v=224'
];
/* APP_END */
