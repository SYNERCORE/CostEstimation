...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=275',
  './vendor/react-dom.production.min.js?v=275',
  './vendor/xlsx.full.min.js?v=275',
  './vendor/pdf.min.js?v=275',
  './vendor/mammoth.browser.min.js?v=275',
  './src/constants.js?v=275',
  './src/helpers.js?v=275',
  './src/approval.js?v=275',
  './src/xlsx-styled.js?v=275',
  './src/ai.js?v=275',
  './src/ai_models.js?v=275',
  './src/config.js?v=275',
  './src/update.js?v=275',
  './src/qr.js?v=275',
  './src/sp.js?v=275',
  ...
  './src/db.js?v=275',
  './src/auth.js?v=275',
  './src/components/LoginPage.js?v=275',
  './src/components/RegisterPage.js?v=275',
  './src/components/CompanyDBPanel.js?v=275',
  './src/components/CeDefaultsPanel.js?v=275',
  './src/components/ShiftRatesPanel.js?v=275',
  './src/components/FbSetupPanel.js?v=275',
  './src/components/LocalToSPSync.js?v=275',
  './src/components/ChangePasswordModal.js?v=275',
  './src/components/UpdatePublisher.js?v=275',
  './src/components/AdminPanel.js?v=275',
  './src/components/ResTab.js?v=275',
  './src/App.js?v=275',
  './src/widgets.js?v=275',
  './src/tests.js?v=275',
  './src/ml_utils.js?v=275'
];
/* APP_END */
