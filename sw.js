...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=140',
  './vendor/react-dom.production.min.js?v=140',
  './vendor/xlsx.full.min.js?v=140',
  './vendor/pdf.min.js?v=140',
  './vendor/mammoth.browser.min.js?v=140',
  './src/constants.js?v=140',
  './src/helpers.js?v=140',
  './src/xlsx-styled.js?v=140',
  './src/ai.js?v=140',
  './src/ai_models.js?v=140',
  './src/config.js?v=140',
  './src/update.js?v=140',
  './src/sp.js?v=140',
  './src/idb.js?v=140',
  './src/db.js?v=140',
  './src/auth.js?v=140',
  './src/components/LoginPage.js?v=140',
  './src/components/RegisterPage.js?v=140',
  './src/components/CompanyDBPanel.js?v=140',
  './src/components/CeDefaultsPanel.js?v=140',
  './src/components/FbSetupPanel.js?v=140',
  './src/components/LocalToSPSync.js?v=140',
  './src/components/ChangePasswordModal.js?v=140',
  './src/components/UpdatePublisher.js?v=140',
  './src/components/AdminPanel.js?v=140',
  './src/components/ResTab.js?v=140',
  './src/App.js?v=140',
  './src/widgets.js?v=140',
  './src/tests.js?v=140',
  './src/ml_utils.js?v=140'
];
/* APP_END */
