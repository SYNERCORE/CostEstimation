...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=185',
  './vendor/react-dom.production.min.js?v=185',
  './vendor/xlsx.full.min.js?v=185',
  './vendor/pdf.min.js?v=185',
  './vendor/mammoth.browser.min.js?v=185',
  './src/constants.js?v=185',
  './src/helpers.js?v=185',
  './src/xlsx-styled.js?v=185',
  './src/ai.js?v=185',
  './src/ai_models.js?v=185',
  './src/config.js?v=185',
  './src/update.js?v=185',
  './src/sp.js?v=185',
  './src/idb.js?v=185',
  './src/db.js?v=185',
  './src/auth.js?v=185',
  './src/components/LoginPage.js?v=185',
  './src/components/RegisterPage.js?v=185',
  './src/components/CompanyDBPanel.js?v=185',
  './src/components/CeDefaultsPanel.js?v=185',
  './src/components/ShiftRatesPanel.js?v=185',
  './src/components/FbSetupPanel.js?v=185',
  './src/components/LocalToSPSync.js?v=185',
  './src/components/ChangePasswordModal.js?v=185',
  './src/components/UpdatePublisher.js?v=185',
  './src/components/AdminPanel.js?v=185',
  './src/components/ResTab.js?v=185',
  './src/App.js?v=185',
  './src/widgets.js?v=185',
  './src/tests.js?v=185',
  './src/ml_utils.js?v=185'
];
/* APP_END */
