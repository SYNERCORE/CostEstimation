...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=176',
  './vendor/react-dom.production.min.js?v=176',
  './vendor/xlsx.full.min.js?v=176',
  './vendor/pdf.min.js?v=176',
  './vendor/mammoth.browser.min.js?v=176',
  './src/constants.js?v=176',
  './src/helpers.js?v=176',
  './src/xlsx-styled.js?v=176',
  './src/ai.js?v=176',
  './src/ai_models.js?v=176',
  './src/config.js?v=176',
  './src/update.js?v=176',
  './src/sp.js?v=176',
  './src/idb.js?v=176',
  './src/db.js?v=176',
  './src/auth.js?v=176',
  './src/components/LoginPage.js?v=176',
  './src/components/RegisterPage.js?v=176',
  './src/components/CompanyDBPanel.js?v=176',
  './src/components/CeDefaultsPanel.js?v=176',
  './src/components/FbSetupPanel.js?v=176',
  './src/components/LocalToSPSync.js?v=176',
  './src/components/ChangePasswordModal.js?v=176',
  './src/components/UpdatePublisher.js?v=176',
  './src/components/AdminPanel.js?v=176',
  './src/components/ResTab.js?v=176',
  './src/App.js?v=176',
  './src/widgets.js?v=176',
  './src/tests.js?v=176',
  './src/ml_utils.js?v=176'
];
/* APP_END */
