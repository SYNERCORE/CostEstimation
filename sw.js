...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=237',
  './vendor/react-dom.production.min.js?v=237',
  './vendor/xlsx.full.min.js?v=237',
  './vendor/pdf.min.js?v=237',
  './vendor/mammoth.browser.min.js?v=237',
  './src/constants.js?v=237',
  './src/helpers.js?v=237',
  './src/approval.js?v=237',
  './src/xlsx-styled.js?v=237',
  './src/ai.js?v=237',
  './src/ai_models.js?v=237',
  './src/config.js?v=237',
  './src/update.js?v=237',
  './src/sp.js?v=237',
  './src/idb.js?v=237',
  './src/db.js?v=237',
  './src/auth.js?v=237',
  './src/components/LoginPage.js?v=237',
  './src/components/RegisterPage.js?v=237',
  './src/components/CompanyDBPanel.js?v=237',
  './src/components/CeDefaultsPanel.js?v=237',
  './src/components/ShiftRatesPanel.js?v=237',
  './src/components/FbSetupPanel.js?v=237',
  './src/components/LocalToSPSync.js?v=237',
  './src/components/ChangePasswordModal.js?v=237',
  './src/components/UpdatePublisher.js?v=237',
  './src/components/AdminPanel.js?v=237',
  './src/components/ResTab.js?v=237',
  './src/App.js?v=237',
  './src/widgets.js?v=237',
  './src/tests.js?v=237',
  './src/ml_utils.js?v=237'
];
/* APP_END */
