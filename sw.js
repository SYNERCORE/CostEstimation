...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=283',
  './vendor/react-dom.production.min.js?v=283',
  './vendor/xlsx.full.min.js?v=283',
  './vendor/pdf.min.js?v=283',
  './vendor/mammoth.browser.min.js?v=283',
  './src/constants.js?v=283',
  './src/helpers.js?v=283',
  './src/approval.js?v=283',
  './src/xlsx-styled.js?v=283',
  './src/ai.js?v=283',
  './src/ai_models.js?v=283',
  './src/config.js?v=283',
  './src/update.js?v=283',
  './src/qr.js?v=283',
  './src/sp.js?v=283',
  ...
  './src/db.js?v=283',
  './src/auth.js?v=283',
  './src/components/LoginPage.js?v=283',
  './src/components/RegisterPage.js?v=283',
  './src/components/CompanyDBPanel.js?v=283',
  './src/components/CeDefaultsPanel.js?v=283',
  './src/components/ShiftRatesPanel.js?v=283',
  './src/components/FbSetupPanel.js?v=283',
  './src/components/LocalToSPSync.js?v=283',
  './src/components/ChangePasswordModal.js?v=283',
  './src/components/UpdatePublisher.js?v=283',
  './src/components/AdminPanel.js?v=283',
  './src/components/RceChecklistCard.js?v=283',
  './src/components/ResTab.js?v=283',
  './src/App.js?v=283',
  './src/widgets.js?v=283',
  './src/tests.js?v=283',
  './src/ml_utils.js?v=283'
];
/* APP_END */
