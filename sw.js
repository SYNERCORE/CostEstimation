...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=164',
  './vendor/react-dom.production.min.js?v=164',
  './vendor/xlsx.full.min.js?v=164',
  './vendor/pdf.min.js?v=164',
  './vendor/mammoth.browser.min.js?v=164',
  './src/constants.js?v=164',
  './src/helpers.js?v=164',
  './src/xlsx-styled.js?v=164',
  './src/ai.js?v=164',
  './src/ai_models.js?v=164',
  './src/config.js?v=164',
  './src/update.js?v=164',
  './src/sp.js?v=164',
  './src/idb.js?v=164',
  './src/db.js?v=164',
  './src/auth.js?v=164',
  './src/components/LoginPage.js?v=164',
  './src/components/RegisterPage.js?v=164',
  './src/components/CompanyDBPanel.js?v=164',
  './src/components/CeDefaultsPanel.js?v=164',
  './src/components/FbSetupPanel.js?v=164',
  './src/components/LocalToSPSync.js?v=164',
  './src/components/ChangePasswordModal.js?v=164',
  './src/components/UpdatePublisher.js?v=164',
  './src/components/AdminPanel.js?v=164',
  './src/components/ResTab.js?v=164',
  './src/App.js?v=164',
  './src/widgets.js?v=164',
  './src/tests.js?v=164',
  './src/ml_utils.js?v=164'
];
/* APP_END */
