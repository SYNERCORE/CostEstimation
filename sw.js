...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=126',
  './vendor/react-dom.production.min.js?v=126',
  './vendor/xlsx.full.min.js?v=126',
  './vendor/pdf.min.js?v=126',
  './vendor/mammoth.browser.min.js?v=126',
  './src/constants.js?v=126',
  './src/helpers.js?v=126',
  './src/xlsx-styled.js?v=126',
  './src/ai.js?v=126',
  './src/ai_models.js?v=126',
  './src/config.js?v=126',
  './src/update.js?v=126',
  './src/sp.js?v=126',
  './src/idb.js?v=126',
  './src/db.js?v=126',
  './src/auth.js?v=126',
  './src/components/LoginPage.js?v=126',
  './src/components/RegisterPage.js?v=126',
  './src/components/CompanyDBPanel.js?v=126',
  './src/components/CeDefaultsPanel.js?v=126',
  './src/components/FbSetupPanel.js?v=126',
  './src/components/LocalToSPSync.js?v=126',
  './src/components/ChangePasswordModal.js?v=126',
  './src/components/UpdatePublisher.js?v=126',
  './src/components/AdminPanel.js?v=126',
  './src/components/ResTab.js?v=126',
  './src/App.js?v=126',
  './src/widgets.js?v=126',
  './src/tests.js?v=126',
  './src/ml_utils.js?v=126'
];
/* APP_END */
