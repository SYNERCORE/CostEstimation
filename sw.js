...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=278',
  './vendor/react-dom.production.min.js?v=278',
  './vendor/xlsx.full.min.js?v=278',
  './vendor/pdf.min.js?v=278',
  './vendor/mammoth.browser.min.js?v=278',
  './src/constants.js?v=278',
  './src/helpers.js?v=278',
  './src/approval.js?v=278',
  './src/xlsx-styled.js?v=278',
  './src/ai.js?v=278',
  './src/ai_models.js?v=278',
  './src/config.js?v=278',
  './src/update.js?v=278',
  './src/qr.js?v=278',
  './src/sp.js?v=278',
  ...
  './src/db.js?v=278',
  './src/auth.js?v=278',
  './src/components/LoginPage.js?v=278',
  './src/components/RegisterPage.js?v=278',
  './src/components/CompanyDBPanel.js?v=278',
  './src/components/CeDefaultsPanel.js?v=278',
  './src/components/ShiftRatesPanel.js?v=278',
  './src/components/FbSetupPanel.js?v=278',
  './src/components/LocalToSPSync.js?v=278',
  './src/components/ChangePasswordModal.js?v=278',
  './src/components/UpdatePublisher.js?v=278',
  './src/components/AdminPanel.js?v=278',
  './src/components/RceChecklistCard.js?v=278',
  './src/components/ResTab.js?v=278',
  './src/App.js?v=278',
  './src/widgets.js?v=278',
  './src/tests.js?v=278',
  './src/ml_utils.js?v=278'
];
/* APP_END */
