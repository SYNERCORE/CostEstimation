...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=211',
  './vendor/react-dom.production.min.js?v=211',
  './vendor/xlsx.full.min.js?v=211',
  './vendor/pdf.min.js?v=211',
  './vendor/mammoth.browser.min.js?v=211',
  './src/constants.js?v=211',
  './src/helpers.js?v=211',
  './src/xlsx-styled.js?v=211',
  './src/ai.js?v=211',
  './src/ai_models.js?v=211',
  './src/config.js?v=211',
  './src/update.js?v=211',
  './src/sp.js?v=211',
  './src/idb.js?v=211',
  './src/db.js?v=211',
  './src/auth.js?v=211',
  './src/components/LoginPage.js?v=211',
  './src/components/RegisterPage.js?v=211',
  './src/components/CompanyDBPanel.js?v=211',
  './src/components/CeDefaultsPanel.js?v=211',
  './src/components/ShiftRatesPanel.js?v=211',
  './src/components/FbSetupPanel.js?v=211',
  './src/components/LocalToSPSync.js?v=211',
  './src/components/ChangePasswordModal.js?v=211',
  './src/components/UpdatePublisher.js?v=211',
  './src/components/AdminPanel.js?v=211',
  './src/components/ResTab.js?v=211',
  './src/App.js?v=211',
  './src/widgets.js?v=211',
  './src/tests.js?v=211',
  './src/ml_utils.js?v=211'
];
/* APP_END */
