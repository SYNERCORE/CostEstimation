...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=141',
  './vendor/react-dom.production.min.js?v=141',
  './vendor/xlsx.full.min.js?v=141',
  './vendor/pdf.min.js?v=141',
  './vendor/mammoth.browser.min.js?v=141',
  './src/constants.js?v=141',
  './src/helpers.js?v=141',
  './src/xlsx-styled.js?v=141',
  './src/ai.js?v=141',
  './src/ai_models.js?v=141',
  './src/config.js?v=141',
  './src/update.js?v=141',
  './src/sp.js?v=141',
  './src/idb.js?v=141',
  './src/db.js?v=141',
  './src/auth.js?v=141',
  './src/components/LoginPage.js?v=141',
  './src/components/RegisterPage.js?v=141',
  './src/components/CompanyDBPanel.js?v=141',
  './src/components/CeDefaultsPanel.js?v=141',
  './src/components/FbSetupPanel.js?v=141',
  './src/components/LocalToSPSync.js?v=141',
  './src/components/ChangePasswordModal.js?v=141',
  './src/components/UpdatePublisher.js?v=141',
  './src/components/AdminPanel.js?v=141',
  './src/components/ResTab.js?v=141',
  './src/App.js?v=141',
  './src/widgets.js?v=141',
  './src/tests.js?v=141',
  './src/ml_utils.js?v=141'
];
/* APP_END */
