...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=97',
  './vendor/react-dom.production.min.js?v=97',
  './vendor/xlsx.full.min.js?v=97',
  './vendor/pdf.min.js?v=97',
  './vendor/mammoth.browser.min.js?v=97',
  './src/constants.js?v=97',
  './src/helpers.js?v=97',
  './src/xlsx-styled.js?v=97',
  './src/ai.js?v=97',
  './src/ai_models.js?v=97',
  './src/config.js?v=97',
  './src/update.js?v=97',
  './src/sp.js?v=97',
  './src/idb.js?v=97',
  './src/db.js?v=97',
  './src/auth.js?v=97',
  './src/components/LoginPage.js?v=97',
  './src/components/RegisterPage.js?v=97',
  './src/components/CompanyDBPanel.js?v=97',
  './src/components/CeDefaultsPanel.js?v=97',
  './src/components/FbSetupPanel.js?v=97',
  './src/components/LocalToSPSync.js?v=97',
  './src/components/ChangePasswordModal.js?v=97',
  './src/components/UpdatePublisher.js?v=97',
  './src/components/AdminPanel.js?v=97',
  './src/components/ResTab.js?v=97',
  './src/App.js?v=97',
  './src/widgets.js?v=97',
  './src/tests.js?v=97',
  './src/ml_utils.js?v=97'
];
/* APP_END */
