...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=139',
  './vendor/react-dom.production.min.js?v=139',
  './vendor/xlsx.full.min.js?v=139',
  './vendor/pdf.min.js?v=139',
  './vendor/mammoth.browser.min.js?v=139',
  './src/constants.js?v=139',
  './src/helpers.js?v=139',
  './src/xlsx-styled.js?v=139',
  './src/ai.js?v=139',
  './src/ai_models.js?v=139',
  './src/config.js?v=139',
  './src/update.js?v=139',
  './src/sp.js?v=139',
  './src/idb.js?v=139',
  './src/db.js?v=139',
  './src/auth.js?v=139',
  './src/components/LoginPage.js?v=139',
  './src/components/RegisterPage.js?v=139',
  './src/components/CompanyDBPanel.js?v=139',
  './src/components/CeDefaultsPanel.js?v=139',
  './src/components/FbSetupPanel.js?v=139',
  './src/components/LocalToSPSync.js?v=139',
  './src/components/ChangePasswordModal.js?v=139',
  './src/components/UpdatePublisher.js?v=139',
  './src/components/AdminPanel.js?v=139',
  './src/components/ResTab.js?v=139',
  './src/App.js?v=139',
  './src/widgets.js?v=139',
  './src/tests.js?v=139',
  './src/ml_utils.js?v=139'
];
/* APP_END */
