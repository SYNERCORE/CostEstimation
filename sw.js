...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=120',
  './vendor/react-dom.production.min.js?v=120',
  './vendor/xlsx.full.min.js?v=120',
  './vendor/pdf.min.js?v=120',
  './vendor/mammoth.browser.min.js?v=120',
  './src/constants.js?v=120',
  './src/helpers.js?v=120',
  './src/xlsx-styled.js?v=120',
  './src/ai.js?v=120',
  './src/ai_models.js?v=120',
  './src/config.js?v=120',
  './src/update.js?v=120',
  './src/sp.js?v=120',
  './src/idb.js?v=120',
  './src/db.js?v=120',
  './src/auth.js?v=120',
  './src/components/LoginPage.js?v=120',
  './src/components/RegisterPage.js?v=120',
  './src/components/CompanyDBPanel.js?v=120',
  './src/components/CeDefaultsPanel.js?v=120',
  './src/components/FbSetupPanel.js?v=120',
  './src/components/LocalToSPSync.js?v=120',
  './src/components/ChangePasswordModal.js?v=120',
  './src/components/UpdatePublisher.js?v=120',
  './src/components/AdminPanel.js?v=120',
  './src/components/ResTab.js?v=120',
  './src/App.js?v=120',
  './src/widgets.js?v=120',
  './src/tests.js?v=120',
  './src/ml_utils.js?v=120'
];
/* APP_END */
