...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=214',
  './vendor/react-dom.production.min.js?v=214',
  './vendor/xlsx.full.min.js?v=214',
  './vendor/pdf.min.js?v=214',
  './vendor/mammoth.browser.min.js?v=214',
  './src/constants.js?v=214',
  './src/helpers.js?v=214',
  './src/approval.js?v=214',
  './src/xlsx-styled.js?v=214',
  './src/ai.js?v=214',
  './src/ai_models.js?v=214',
  './src/config.js?v=214',
  './src/update.js?v=214',
  './src/sp.js?v=214',
  './src/idb.js?v=214',
  './src/db.js?v=214',
  './src/auth.js?v=214',
  './src/components/LoginPage.js?v=214',
  './src/components/RegisterPage.js?v=214',
  './src/components/CompanyDBPanel.js?v=214',
  './src/components/CeDefaultsPanel.js?v=214',
  './src/components/ShiftRatesPanel.js?v=214',
  './src/components/FbSetupPanel.js?v=214',
  './src/components/LocalToSPSync.js?v=214',
  './src/components/ChangePasswordModal.js?v=214',
  './src/components/UpdatePublisher.js?v=214',
  './src/components/AdminPanel.js?v=214',
  './src/components/ResTab.js?v=214',
  './src/App.js?v=214',
  './src/widgets.js?v=214',
  './src/tests.js?v=214',
  './src/ml_utils.js?v=214'
];
/* APP_END */
