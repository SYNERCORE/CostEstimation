...
async function autoSetupSP(progressCb){
  ...
  const lists={
    ...
    [spList('CE_Resources')]:[[9,'shicCEId'],[2,'shicTab'],[2,'shicDesc'],[9,'shicQty'],[2,'shicUOM'],[9,'shicCost'],[9,'shicDays'],[2,'shicTaskId'],[3,'shicShares'],[9,'shicTier'],[9,'shicHours'],[9,'shicKW'],[9,'shicRunHrs']],
