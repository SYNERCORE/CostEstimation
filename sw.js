...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=92',
  './vendor/react-dom.production.min.js?v=92',
  './vendor/xlsx.full.min.js?v=92',
  './vendor/pdf.min.js?v=92',
  './vendor/mammoth.browser.min.js?v=92',
  './src/constants.js?v=92',
  './src/helpers.js?v=92',
  './src/xlsx-styled.js?v=92',
  './src/ai.js?v=92',
  './src/ai_models.js?v=92',
  './src/config.js?v=92',
  './src/update.js?v=92',
  './src/sp.js?v=92',
  './src/idb.js?v=92',
  './src/db.js?v=92',
  './src/auth.js?v=92',
  './src/components/LoginPage.js?v=92',
  './src/components/RegisterPage.js?v=92',
  './src/components/CompanyDBPanel.js?v=92',
  './src/components/CeDefaultsPanel.js?v=92',
  './src/components/FbSetupPanel.js?v=92',
  './src/components/LocalToSPSync.js?v=92',
  './src/components/ChangePasswordModal.js?v=92',
  './src/components/UpdatePublisher.js?v=92',
  './src/components/AdminPanel.js?v=92',
  './src/components/ResTab.js?v=92',
  './src/App.js?v=92',
  './src/widgets.js?v=92',
  './src/tests.js?v=92',
  './src/ml_utils.js?v=92'
];
/* APP_END */
