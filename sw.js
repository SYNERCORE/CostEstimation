...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=210',
  './vendor/react-dom.production.min.js?v=210',
  './vendor/xlsx.full.min.js?v=210',
  './vendor/pdf.min.js?v=210',
  './vendor/mammoth.browser.min.js?v=210',
  './src/constants.js?v=210',
  './src/helpers.js?v=210',
  './src/xlsx-styled.js?v=210',
  './src/ai.js?v=210',
  './src/ai_models.js?v=210',
  './src/config.js?v=210',
  './src/update.js?v=210',
  './src/sp.js?v=210',
  './src/idb.js?v=210',
  './src/db.js?v=210',
  './src/auth.js?v=210',
  './src/components/LoginPage.js?v=210',
  './src/components/RegisterPage.js?v=210',
  './src/components/CompanyDBPanel.js?v=210',
  './src/components/CeDefaultsPanel.js?v=210',
  './src/components/ShiftRatesPanel.js?v=210',
  './src/components/FbSetupPanel.js?v=210',
  './src/components/LocalToSPSync.js?v=210',
  './src/components/ChangePasswordModal.js?v=210',
  './src/components/UpdatePublisher.js?v=210',
  './src/components/AdminPanel.js?v=210',
  './src/components/ResTab.js?v=210',
  './src/App.js?v=210',
  './src/widgets.js?v=210',
  './src/tests.js?v=210',
  './src/ml_utils.js?v=210'
];
/* APP_END */
