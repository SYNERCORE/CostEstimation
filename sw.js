...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=259',
  './vendor/react-dom.production.min.js?v=259',
  './vendor/xlsx.full.min.js?v=259',
  './vendor/pdf.min.js?v=259',
  './vendor/mammoth.browser.min.js?v=259',
  './src/constants.js?v=259',
  './src/helpers.js?v=259',
  './src/approval.js?v=259',
  './src/xlsx-styled.js?v=259',
  './src/ai.js?v=259',
  './src/ai_models.js?v=259',
  './src/config.js?v=259',
  './src/update.js?v=259',
  './src/qr.js?v=259',
  './src/sp.js?v=259',
  ...
  './src/db.js?v=259',
  './src/auth.js?v=259',
  './src/components/LoginPage.js?v=259',
  './src/components/RegisterPage.js?v=259',
  './src/components/CompanyDBPanel.js?v=259',
  './src/components/CeDefaultsPanel.js?v=259',
  './src/components/ShiftRatesPanel.js?v=259',
  './src/components/FbSetupPanel.js?v=259',
  './src/components/LocalToSPSync.js?v=259',
  './src/components/ChangePasswordModal.js?v=259',
  './src/components/UpdatePublisher.js?v=259',
  './src/components/AdminPanel.js?v=259',
  './src/components/ResTab.js?v=259',
  './src/App.js?v=259',
  './src/widgets.js?v=259',
  './src/tests.js?v=259',
  './src/ml_utils.js?v=259'
];
/* APP_END */
