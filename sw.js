...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=75',
  './vendor/react-dom.production.min.js?v=75',
  './vendor/xlsx.full.min.js?v=75',
  './vendor/pdf.min.js?v=75',
  './vendor/mammoth.browser.min.js?v=75',
  './src/constants.js?v=75',
  './src/helpers.js?v=75',
  './src/xlsx-styled.js?v=75',
  './src/ai.js?v=75',
  './src/ai_models.js?v=75',
  './src/config.js?v=75',
  './src/update.js?v=75',
  './src/sp.js?v=75',
  './src/idb.js?v=75',
  './src/db.js?v=75',
  './src/auth.js?v=75',
  './src/components/LoginPage.js?v=75',
  './src/components/RegisterPage.js?v=75',
  './src/components/CompanyDBPanel.js?v=75',
  './src/components/FbSetupPanel.js?v=75',
  './src/components/LocalToSPSync.js?v=75',
  './src/components/ChangePasswordModal.js?v=75',
  './src/components/UpdatePublisher.js?v=75',
  './src/components/AdminPanel.js?v=75',
  './src/components/ResTab.js?v=75',
  './src/App.js?v=75',
  './src/widgets.js?v=75',
  './src/tests.js?v=75',
  './src/ml_utils.js?v=75'
];
/* APP_END */
