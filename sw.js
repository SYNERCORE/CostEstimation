...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=137',
  './vendor/react-dom.production.min.js?v=137',
  './vendor/xlsx.full.min.js?v=137',
  './vendor/pdf.min.js?v=137',
  './vendor/mammoth.browser.min.js?v=137',
  './src/constants.js?v=137',
  './src/helpers.js?v=137',
  './src/xlsx-styled.js?v=137',
  './src/ai.js?v=137',
  './src/ai_models.js?v=137',
  './src/config.js?v=137',
  './src/update.js?v=137',
  './src/sp.js?v=137',
  './src/idb.js?v=137',
  './src/db.js?v=137',
  './src/auth.js?v=137',
  './src/components/LoginPage.js?v=137',
  './src/components/RegisterPage.js?v=137',
  './src/components/CompanyDBPanel.js?v=137',
  './src/components/CeDefaultsPanel.js?v=137',
  './src/components/FbSetupPanel.js?v=137',
  './src/components/LocalToSPSync.js?v=137',
  './src/components/ChangePasswordModal.js?v=137',
  './src/components/UpdatePublisher.js?v=137',
  './src/components/AdminPanel.js?v=137',
  './src/components/ResTab.js?v=137',
  './src/App.js?v=137',
  './src/widgets.js?v=137',
  './src/tests.js?v=137',
  './src/ml_utils.js?v=137'
];
/* APP_END */
