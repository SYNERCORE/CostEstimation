...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=102',
  './vendor/react-dom.production.min.js?v=102',
  './vendor/xlsx.full.min.js?v=102',
  './vendor/pdf.min.js?v=102',
  './vendor/mammoth.browser.min.js?v=102',
  './src/constants.js?v=102',
  './src/helpers.js?v=102',
  './src/xlsx-styled.js?v=102',
  './src/ai.js?v=102',
  './src/ai_models.js?v=102',
  './src/config.js?v=102',
  './src/update.js?v=102',
  './src/sp.js?v=102',
  './src/idb.js?v=102',
  './src/db.js?v=102',
  './src/auth.js?v=102',
  './src/components/LoginPage.js?v=102',
  './src/components/RegisterPage.js?v=102',
  './src/components/CompanyDBPanel.js?v=102',
  './src/components/CeDefaultsPanel.js?v=102',
  './src/components/FbSetupPanel.js?v=102',
  './src/components/LocalToSPSync.js?v=102',
  './src/components/ChangePasswordModal.js?v=102',
  './src/components/UpdatePublisher.js?v=102',
  './src/components/AdminPanel.js?v=102',
  './src/components/ResTab.js?v=102',
  './src/App.js?v=102',
  './src/widgets.js?v=102',
  './src/tests.js?v=102',
  './src/ml_utils.js?v=102'
];
/* APP_END */
