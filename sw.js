...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=239',
  './vendor/react-dom.production.min.js?v=239',
  './vendor/xlsx.full.min.js?v=239',
  './vendor/pdf.min.js?v=239',
  './vendor/mammoth.browser.min.js?v=239',
  './src/constants.js?v=239',
  './src/helpers.js?v=239',
  './src/approval.js?v=239',
  './src/xlsx-styled.js?v=239',
  './src/ai.js?v=239',
  './src/ai_models.js?v=239',
  './src/config.js?v=239',
  './src/update.js?v=239',
  './src/sp.js?v=239',
  './src/idb.js?v=239',
  './src/db.js?v=239',
  './src/auth.js?v=239',
  './src/components/LoginPage.js?v=239',
  './src/components/RegisterPage.js?v=239',
  './src/components/CompanyDBPanel.js?v=239',
  './src/components/CeDefaultsPanel.js?v=239',
  './src/components/ShiftRatesPanel.js?v=239',
  './src/components/FbSetupPanel.js?v=239',
  './src/components/LocalToSPSync.js?v=239',
  './src/components/ChangePasswordModal.js?v=239',
  './src/components/UpdatePublisher.js?v=239',
  './src/components/AdminPanel.js?v=239',
  './src/components/ResTab.js?v=239',
  './src/App.js?v=239',
  './src/widgets.js?v=239',
  './src/tests.js?v=239',
  './src/ml_utils.js?v=239'
];
/* APP_END */
