...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=96',
  './vendor/react-dom.production.min.js?v=96',
  './vendor/xlsx.full.min.js?v=96',
  './vendor/pdf.min.js?v=96',
  './vendor/mammoth.browser.min.js?v=96',
  './src/constants.js?v=96',
  './src/helpers.js?v=96',
  './src/xlsx-styled.js?v=96',
  './src/ai.js?v=96',
  './src/ai_models.js?v=96',
  './src/config.js?v=96',
  './src/update.js?v=96',
  './src/sp.js?v=96',
  './src/idb.js?v=96',
  './src/db.js?v=96',
  './src/auth.js?v=96',
  './src/components/LoginPage.js?v=96',
  './src/components/RegisterPage.js?v=96',
  './src/components/CompanyDBPanel.js?v=96',
  './src/components/CeDefaultsPanel.js?v=96',
  './src/components/FbSetupPanel.js?v=96',
  './src/components/LocalToSPSync.js?v=96',
  './src/components/ChangePasswordModal.js?v=96',
  './src/components/UpdatePublisher.js?v=96',
  './src/components/AdminPanel.js?v=96',
  './src/components/ResTab.js?v=96',
  './src/App.js?v=96',
  './src/widgets.js?v=96',
  './src/tests.js?v=96',
  './src/ml_utils.js?v=96'
];
/* APP_END */
