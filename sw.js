...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=83',
  './vendor/react-dom.production.min.js?v=83',
  './vendor/xlsx.full.min.js?v=83',
  './vendor/pdf.min.js?v=83',
  './vendor/mammoth.browser.min.js?v=83',
  './src/constants.js?v=83',
  './src/helpers.js?v=83',
  './src/xlsx-styled.js?v=83',
  './src/ai.js?v=83',
  './src/ai_models.js?v=83',
  './src/config.js?v=83',
  './src/update.js?v=83',
  './src/sp.js?v=83',
  './src/idb.js?v=83',
  './src/db.js?v=83',
  './src/auth.js?v=83',
  './src/components/LoginPage.js?v=83',
  './src/components/RegisterPage.js?v=83',
  './src/components/CompanyDBPanel.js?v=83',
  './src/components/FbSetupPanel.js?v=83',
  './src/components/LocalToSPSync.js?v=83',
  './src/components/ChangePasswordModal.js?v=83',
  './src/components/UpdatePublisher.js?v=83',
  './src/components/AdminPanel.js?v=83',
  './src/components/ResTab.js?v=83',
  './src/App.js?v=83',
  './src/widgets.js?v=83',
  './src/tests.js?v=83',
  './src/ml_utils.js?v=83'
];
/* APP_END */
