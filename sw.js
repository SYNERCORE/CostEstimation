...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=143',
  './vendor/react-dom.production.min.js?v=143',
  './vendor/xlsx.full.min.js?v=143',
  './vendor/pdf.min.js?v=143',
  './vendor/mammoth.browser.min.js?v=143',
  './src/constants.js?v=143',
  './src/helpers.js?v=143',
  './src/xlsx-styled.js?v=143',
  './src/ai.js?v=143',
  './src/ai_models.js?v=143',
  './src/config.js?v=143',
  './src/update.js?v=143',
  './src/sp.js?v=143',
  './src/idb.js?v=143',
  './src/db.js?v=143',
  './src/auth.js?v=143',
  './src/components/LoginPage.js?v=143',
  './src/components/RegisterPage.js?v=143',
  './src/components/CompanyDBPanel.js?v=143',
  './src/components/CeDefaultsPanel.js?v=143',
  './src/components/FbSetupPanel.js?v=143',
  './src/components/LocalToSPSync.js?v=143',
  './src/components/ChangePasswordModal.js?v=143',
  './src/components/UpdatePublisher.js?v=143',
  './src/components/AdminPanel.js?v=143',
  './src/components/ResTab.js?v=143',
  './src/App.js?v=143',
  './src/widgets.js?v=143',
  './src/tests.js?v=143',
  './src/ml_utils.js?v=143'
];
/* APP_END */
