...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=270',
  './vendor/react-dom.production.min.js?v=270',
  './vendor/xlsx.full.min.js?v=270',
  './vendor/pdf.min.js?v=270',
  './vendor/mammoth.browser.min.js?v=270',
  './src/constants.js?v=270',
  './src/helpers.js?v=270',
  './src/approval.js?v=270',
  './src/xlsx-styled.js?v=270',
  './src/ai.js?v=270',
  './src/ai_models.js?v=270',
  './src/config.js?v=270',
  './src/update.js?v=270',
  './src/qr.js?v=270',
  './src/sp.js?v=270',
  ...
  './src/db.js?v=270',
  './src/auth.js?v=270',
  './src/components/LoginPage.js?v=270',
  './src/components/RegisterPage.js?v=270',
  './src/components/CompanyDBPanel.js?v=270',
  './src/components/CeDefaultsPanel.js?v=270',
  './src/components/ShiftRatesPanel.js?v=270',
  './src/components/FbSetupPanel.js?v=270',
  './src/components/LocalToSPSync.js?v=270',
  './src/components/ChangePasswordModal.js?v=270',
  './src/components/UpdatePublisher.js?v=270',
  './src/components/AdminPanel.js?v=270',
  './src/components/ResTab.js?v=270',
  './src/App.js?v=270',
  './src/widgets.js?v=270',
  './src/tests.js?v=270',
  './src/ml_utils.js?v=270'
];
/* APP_END */
