...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=136',
  './vendor/react-dom.production.min.js?v=136',
  './vendor/xlsx.full.min.js?v=136',
  './vendor/pdf.min.js?v=136',
  './vendor/mammoth.browser.min.js?v=136',
  './src/constants.js?v=136',
  './src/helpers.js?v=136',
  './src/xlsx-styled.js?v=136',
  './src/ai.js?v=136',
  './src/ai_models.js?v=136',
  './src/config.js?v=136',
  './src/update.js?v=136',
  './src/sp.js?v=136',
  './src/idb.js?v=136',
  './src/db.js?v=136',
  './src/auth.js?v=136',
  './src/components/LoginPage.js?v=136',
  './src/components/RegisterPage.js?v=136',
  './src/components/CompanyDBPanel.js?v=136',
  './src/components/CeDefaultsPanel.js?v=136',
  './src/components/FbSetupPanel.js?v=136',
  './src/components/LocalToSPSync.js?v=136',
  './src/components/ChangePasswordModal.js?v=136',
  './src/components/UpdatePublisher.js?v=136',
  './src/components/AdminPanel.js?v=136',
  './src/components/ResTab.js?v=136',
  './src/App.js?v=136',
  './src/widgets.js?v=136',
  './src/tests.js?v=136',
  './src/ml_utils.js?v=136'
];
/* APP_END */
