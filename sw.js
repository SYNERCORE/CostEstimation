...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=265',
  './vendor/react-dom.production.min.js?v=265',
  './vendor/xlsx.full.min.js?v=265',
  './vendor/pdf.min.js?v=265',
  './vendor/mammoth.browser.min.js?v=265',
  './src/constants.js?v=265',
  './src/helpers.js?v=265',
  './src/approval.js?v=265',
  './src/xlsx-styled.js?v=265',
  './src/ai.js?v=265',
  './src/ai_models.js?v=265',
  './src/config.js?v=265',
  './src/update.js?v=265',
  './src/qr.js?v=265',
  './src/sp.js?v=265',
  ...
  './src/db.js?v=265',
  './src/auth.js?v=265',
  './src/components/LoginPage.js?v=265',
  './src/components/RegisterPage.js?v=265',
  './src/components/CompanyDBPanel.js?v=265',
  './src/components/CeDefaultsPanel.js?v=265',
  './src/components/ShiftRatesPanel.js?v=265',
  './src/components/FbSetupPanel.js?v=265',
  './src/components/LocalToSPSync.js?v=265',
  './src/components/ChangePasswordModal.js?v=265',
  './src/components/UpdatePublisher.js?v=265',
  './src/components/AdminPanel.js?v=265',
  './src/components/ResTab.js?v=265',
  './src/App.js?v=265',
  './src/widgets.js?v=265',
  './src/tests.js?v=265',
  './src/ml_utils.js?v=265'
];
/* APP_END */
