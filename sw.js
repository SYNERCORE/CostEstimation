...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=221',
  './vendor/react-dom.production.min.js?v=221',
  './vendor/xlsx.full.min.js?v=221',
  './vendor/pdf.min.js?v=221',
  './vendor/mammoth.browser.min.js?v=221',
  './src/constants.js?v=221',
  './src/helpers.js?v=221',
  './src/approval.js?v=221',
  './src/xlsx-styled.js?v=221',
  './src/ai.js?v=221',
  './src/ai_models.js?v=221',
  './src/config.js?v=221',
  './src/update.js?v=221',
  './src/sp.js?v=221',
  './src/idb.js?v=221',
  './src/db.js?v=221',
  './src/auth.js?v=221',
  './src/components/LoginPage.js?v=221',
  './src/components/RegisterPage.js?v=221',
  './src/components/CompanyDBPanel.js?v=221',
  './src/components/CeDefaultsPanel.js?v=221',
  './src/components/ShiftRatesPanel.js?v=221',
  './src/components/FbSetupPanel.js?v=221',
  './src/components/LocalToSPSync.js?v=221',
  './src/components/ChangePasswordModal.js?v=221',
  './src/components/UpdatePublisher.js?v=221',
  './src/components/AdminPanel.js?v=221',
  './src/components/ResTab.js?v=221',
  './src/App.js?v=221',
  './src/widgets.js?v=221',
  './src/tests.js?v=221',
  './src/ml_utils.js?v=221'
];
/* APP_END */
