...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=93',
  './vendor/react-dom.production.min.js?v=93',
  './vendor/xlsx.full.min.js?v=93',
  './vendor/pdf.min.js?v=93',
  './vendor/mammoth.browser.min.js?v=93',
  './src/constants.js?v=93',
  './src/helpers.js?v=93',
  './src/xlsx-styled.js?v=93',
  './src/ai.js?v=93',
  './src/ai_models.js?v=93',
  './src/config.js?v=93',
  './src/update.js?v=93',
  './src/sp.js?v=93',
  './src/idb.js?v=93',
  './src/db.js?v=93',
  './src/auth.js?v=93',
  './src/components/LoginPage.js?v=93',
  './src/components/RegisterPage.js?v=93',
  './src/components/CompanyDBPanel.js?v=93',
  './src/components/CeDefaultsPanel.js?v=93',
  './src/components/FbSetupPanel.js?v=93',
  './src/components/LocalToSPSync.js?v=93',
  './src/components/ChangePasswordModal.js?v=93',
  './src/components/UpdatePublisher.js?v=93',
  './src/components/AdminPanel.js?v=93',
  './src/components/ResTab.js?v=93',
  './src/App.js?v=93',
  './src/widgets.js?v=93',
  './src/tests.js?v=93',
  './src/ml_utils.js?v=93'
];
/* APP_END */
