...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=113',
  './vendor/react-dom.production.min.js?v=113',
  './vendor/xlsx.full.min.js?v=113',
  './vendor/pdf.min.js?v=113',
  './vendor/mammoth.browser.min.js?v=113',
  './src/constants.js?v=113',
  './src/helpers.js?v=113',
  './src/xlsx-styled.js?v=113',
  './src/ai.js?v=113',
  './src/ai_models.js?v=113',
  './src/config.js?v=113',
  './src/update.js?v=113',
  './src/sp.js?v=113',
  './src/idb.js?v=113',
  './src/db.js?v=113',
  './src/auth.js?v=113',
  './src/components/LoginPage.js?v=113',
  './src/components/RegisterPage.js?v=113',
  './src/components/CompanyDBPanel.js?v=113',
  './src/components/CeDefaultsPanel.js?v=113',
  './src/components/FbSetupPanel.js?v=113',
  './src/components/LocalToSPSync.js?v=113',
  './src/components/ChangePasswordModal.js?v=113',
  './src/components/UpdatePublisher.js?v=113',
  './src/components/AdminPanel.js?v=113',
  './src/components/ResTab.js?v=113',
  './src/App.js?v=113',
  './src/widgets.js?v=113',
  './src/tests.js?v=113',
  './src/ml_utils.js?v=113'
];
/* APP_END */
