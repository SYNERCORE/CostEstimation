...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=242',
  './vendor/react-dom.production.min.js?v=242',
  './vendor/xlsx.full.min.js?v=242',
  './vendor/pdf.min.js?v=242',
  './vendor/mammoth.browser.min.js?v=242',
  './src/constants.js?v=242',
  './src/helpers.js?v=242',
  './src/approval.js?v=242',
  './src/xlsx-styled.js?v=242',
  './src/ai.js?v=242',
  './src/ai_models.js?v=242',
  './src/config.js?v=242',
  './src/update.js?v=242',
  './src/sp.js?v=242',
  './src/idb.js?v=242',
  './src/db.js?v=242',
  './src/auth.js?v=242',
  './src/components/LoginPage.js?v=242',
  './src/components/RegisterPage.js?v=242',
  './src/components/CompanyDBPanel.js?v=242',
  './src/components/CeDefaultsPanel.js?v=242',
  './src/components/ShiftRatesPanel.js?v=242',
  './src/components/FbSetupPanel.js?v=242',
  './src/components/LocalToSPSync.js?v=242',
  './src/components/ChangePasswordModal.js?v=242',
  './src/components/UpdatePublisher.js?v=242',
  './src/components/AdminPanel.js?v=242',
  './src/components/ResTab.js?v=242',
  './src/App.js?v=242',
  './src/widgets.js?v=242',
  './src/tests.js?v=242',
  './src/ml_utils.js?v=242'
];
/* APP_END */
