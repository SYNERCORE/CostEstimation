...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=90',
  './vendor/react-dom.production.min.js?v=90',
  './vendor/xlsx.full.min.js?v=90',
  './vendor/pdf.min.js?v=90',
  './vendor/mammoth.browser.min.js?v=90',
  './src/constants.js?v=90',
  './src/helpers.js?v=90',
  './src/xlsx-styled.js?v=90',
  './src/ai.js?v=90',
  './src/ai_models.js?v=90',
  './src/config.js?v=90',
  './src/update.js?v=90',
  './src/sp.js?v=90',
  './src/idb.js?v=90',
  './src/db.js?v=90',
  './src/auth.js?v=90',
  './src/components/LoginPage.js?v=90',
  './src/components/RegisterPage.js?v=90',
  './src/components/CompanyDBPanel.js?v=90',
  './src/components/FbSetupPanel.js?v=90',
  './src/components/LocalToSPSync.js?v=90',
  './src/components/ChangePasswordModal.js?v=90',
  './src/components/UpdatePublisher.js?v=90',
  './src/components/AdminPanel.js?v=90',
  './src/components/ResTab.js?v=90',
  './src/App.js?v=90',
  './src/widgets.js?v=90',
  './src/tests.js?v=90',
  './src/ml_utils.js?v=90'
];
/* APP_END */
