...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=193',
  './vendor/react-dom.production.min.js?v=193',
  './vendor/xlsx.full.min.js?v=193',
  './vendor/pdf.min.js?v=193',
  './vendor/mammoth.browser.min.js?v=193',
  './src/constants.js?v=193',
  './src/helpers.js?v=193',
  './src/xlsx-styled.js?v=193',
  './src/ai.js?v=193',
  './src/ai_models.js?v=193',
  './src/config.js?v=193',
  './src/update.js?v=193',
  './src/sp.js?v=193',
  './src/idb.js?v=193',
  './src/db.js?v=193',
  './src/auth.js?v=193',
  './src/components/LoginPage.js?v=193',
  './src/components/RegisterPage.js?v=193',
  './src/components/CompanyDBPanel.js?v=193',
  './src/components/CeDefaultsPanel.js?v=193',
  './src/components/ShiftRatesPanel.js?v=193',
  './src/components/FbSetupPanel.js?v=193',
  './src/components/LocalToSPSync.js?v=193',
  './src/components/ChangePasswordModal.js?v=193',
  './src/components/UpdatePublisher.js?v=193',
  './src/components/AdminPanel.js?v=193',
  './src/components/ResTab.js?v=193',
  './src/App.js?v=193',
  './src/widgets.js?v=193',
  './src/tests.js?v=193',
  './src/ml_utils.js?v=193'
];
/* APP_END */
