...
<div id="shic-ml-panel" style="display:none;position:fixed;top:56px;right:0;width:400px;height:calc(100vh - 56px);background:#161B22;border-left:1px solid #30363D;z-index:200;overflow-y:auto;box-shadow:-4px 0 20px #0008"><div style="padding:12px 14px;border-bottom:1px solid #30363D;display:flex;align-items:center;gap:8px;position:sticky;top:0;background:#161B22"><span style="font-weight:800;font-size:14px;color:#F0A429">&#129504; ML Insights</span><span style="font-size:10px;color:#7D8590;background:#1C2128;border-radius:10px;padding:1px 8px">Beta</span><button onclick="document.getElementById('shic-ml-panel').style.display='none'" style="margin-left:auto;background:none;border:none;color:#7D8590;cursor:pointer;font-size:18px">&times;</button></div><div style="padding:12px 14px;border-bottom:1px solid #30363D33"><div style="font-weight:700;font-size:10px;color:#7D8590;text-transform:uppercase;letter-spacing:.07em;margin-bottom:8px">&#128176; Rate Suggester</div><div style="display:flex;gap:6px;margin-bottom:6px"><input id="ml-role-input" placeholder="Type a role name..." style="flex:1;background:#0D1117;border:1px solid #30363D;color:#E6EDF3;border-radius:6px;padding:6px 10px;font-size:11px;outline:none" onkeydown="if(event.key==='Enter')shicMLRate()"/><button onclick="shicMLRate()" style="background:#F0A429;color:#000;border:none;border-radius:6px;padding:6px 12px;font-weight:700;cursor:pointer;font-size:11px">Check</button></div><div id="ml-rate-result" style="color:#7D8590;font-size:11px">Enter a role to see historical rates.</div></div><div style="padding:12px 14px;border-bottom:1px solid #30363D33"><div style="font-weight:700;font-size:10px;color:#7D8590;text-transform:uppercase;letter-spacing:.07em;margin-bottom:8px">&#128202; Cost Predictor</div><textarea id="ml-scope-input" placeholder="Paste project scope..." style="width:100%;background:#0D1117;border:1px solid #30363D;color:#E6EDF3;border-radius:6px;padding:6px 10px;font-size:11px;outline:none;resize:vertical;height:56px;box-sizing:border-box"></textarea><button onclick="shicMLPredict()" style="margin-top:6px;background:#3B82F6;color:#fff;border:none;border-radius:6px;padding:6px 14px;font-weight:700;cursor:pointer;font-size:11px;width:100%">Predict Cost</button><div id="ml-predict-result" style="color:#7D8590;font-size:11px;margin-top:6px">Enter scope to predict total CE cost.</div></div><div style="padding:12px 14px;border-bottom:1px solid #30363D33"><div style="font-weight:700;font-size:10px;color:#7D8590;text-transform:uppercase;letter-spacing:.07em;margin-bottom:8px">&#128269; Scope Matcher</div><div style="display:flex;gap:6px;margin-bottom:6px"><input id="ml-match-input" placeholder="Describe the work..." style="flex:1;background:#0D1117;border:1px solid #30363D;color:#E6EDF3;border-radius:6px;padding:6px 10px;font-size:11px;outline:none" onkeydown="if(event.key==='Enter')shicMLMatch()"/><button onclick="shicMLMatch()" style="background:#8B5CF6;color:#fff;border:none;border-radius:6px;padding:6px 12px;font-weight:700;cursor:pointer;font-size:11px">Match</button></div><div id="ml-match-result" style="color:#7D8590;font-size:11px">Find similar past CEs.</div></div><div style="padding:12px 14px"><div style="font-weight:700;font-size:10px;color:#7D8590;text-transform:uppercase;letter-spacing:.07em;margin-bottom:8px">&#9888; Anomaly Detection</div><button onclick="shicMLAnomalies()" style="background:#EF4444;color:#fff;border:none;border-radius:6px;padding:6px 14px;font-weight:700;cursor:pointer;font-size:11px;width:100%">Scan Current CE</button><div id="ml-anomaly-result" style="color:#7D8590;font-size:11px;margin-top:6px">Compare CE rates vs Masterlist.</div></div></div>
<div id="shic-od-panel" style="display:none;position:fixed;inset:0;background:#000c;z-index:400;align-items:center;justify-content:center"><div style="background:#161B22;border:1px solid #30363D;border-radius:12px;width:580px;max-height:88vh;display:flex;flex-direction:column;box-shadow:0 8px 40px #0008"><div style="padding:14px 18px;border-bottom:1px solid #30363D;display:flex;align-items:center;gap:10px"><span style="font-size:20px">&#128193;</span><span style="font-weight:800;font-size:15px">Project File Analyzer</span><span style="font-size:10px;background:#1C2128;color:#7D8590;border-radius:10px;padding:2px 8px">ML Training</span><button onclick="document.getElementById('shic-od-panel').style.display='none'" style="margin-left:auto;background:none;border:none;color:#7D8590;cursor:pointer;font-size:20px">&times;</button></div><div style="overflow-y:auto;flex:1;padding:16px 18px"><div style="color:#7D8590;font-size:12px;margin-bottom:12px;padding:10px;background:#0D1117;border-radius:6px;border-left:3px solid #F0A429">Read project files from your desktop. Results are <b style="color:#10B981">saved to SharePoint</b> so all users benefit. Supports <b style="color:#E6EDF3">Excel, PDF, Word</b>.</div><div style="display:flex;gap:4px;margin-bottom:14px;background:#0D1117;border-radius:8px;padding:4px"><button id="tab-local" onclick="switchAnalyzerTab('local')" style="flex:1;background:#30363D;color:#E6EDF3;border:none;border-radius:6px;padding:7px;font-weight:700;cursor:pointer;font-size:12px">&#128193; Local Files</button><button id="tab-od" onclick="switchAnalyzerTab('od')" style="flex:1;background:transparent;color:#7D8590;border:none;border-radius:6px;padding:7px;font-weight:700;cursor:pointer;font-size:12px">&#9729; OneDrive</button></div><div id="analyzer-local"><div style="display:flex;gap:8px;margin-bottom:10px"><button onclick="document.getElementById('local-folder-input').click()" style="flex:1;background:#1C2128;border:1px dashed #30363D;color:#E6EDF3;border-radius:8px;padding:16px 8px;font-size:12px;cursor:pointer" onmouseover="this.style.borderColor='#F0A429'" onmouseout="this.style.borderColor='#30363D'">&#128193; Select Folder<br><span style="font-size:10px;color:#7D8590">All files in folder</span></button><button onclick="document.getElementById('local-file-input').click()" style="flex:1;background:#1C2128;border:1px dashed #30363D;color:#E6EDF3;border-radius:8px;padding:16px 8px;font-size:12px;cursor:pointer" onmouseover="this.style.borderColor='#F0A429'" onmouseout="this.style.borderColor='#30363D'">&#128196; Select Files<br><span style="font-size:10px;color:#7D8590">Individual files</span></button></div><input type="file" id="local-file-input" multiple accept=".xlsx,.xls,.pdf,.docx,.doc" style="display:none" onchange="localFilesSelected(this.files)"/><input type="file" id="local-folder-input" webkitdirectory multiple style="display:none" onchange="localFilesSelected(this.files)"/><div id="local-file-list" style="display:none;margin-bottom:10px;background:#0D1117;border-radius:6px;padding:8px"><div style="font-size:11px;color:#E6EDF3;margin-bottom:4px" id="local-file-count"></div><div id="local-file-names" style="max-height:70px;overflow-y:auto;font-size:10px;color:#7D8590;font-family:monospace"></div></div><button id="local-analyze-btn" onclick="analyzeLocalFiles()" disabled style="width:100%;background:#30363D;color:#7D8590;border:none;border-radius:6px;padding:10px;font-weight:700;cursor:not-allowed;font-size:12px;margin-bottom:10px">Analyze &amp; Save to SharePoint</button><div id="local-progress" style="display:none;padding:10px;background:#0D1117;border-radius:8px;border:1px solid #30363D;margin-bottom:10px"><div id="local-progress-msg" style="font-size:12px;margin-bottom:6px"></div><div style="background:#1C2128;border-radius:6px;height:6px"><div id="local-progress-bar" style="background:#F0A429;height:6px;border-radius:6px;width:0%;transition:width .3s"></div></div></div><div id="local-results" style="display:none"></div></div><div id="analyzer-od" style="display:none"><div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-bottom:10px"><div><label style="display:block;font-size:10px;color:#7D8590;margin-bottom:4px">CLIENT ID</label><input id="od-client-id" style="width:100%;background:#0D1117;border:1px solid #30363D;color:#E6EDF3;border-radius:6px;padding:7px 10px;font-size:11px;outline:none;box-sizing:border-box" placeholder="Azure App Client ID"/></div><div><label style="display:block;font-size:10px;color:#7D8590;margin-bottom:4px">TENANT ID</label><input id="od-tenant-id" style="width:100%;background:#0D1117;border:1px solid #30363D;color:#E6EDF3;border-radius:6px;padding:7px 10px;font-size:11px;outline:none;box-sizing:border-box" placeholder="common"/></div></div><label style="display:block;font-size:10px;color:#7D8590;margin-bottom:4px">FOLDER PATH</label><input id="od-folder" style="width:100%;background:#0D1117;border:1px solid #30363D;color:#E6EDF3;border-radius:6px;padding:7px 10px;font-size:12px;outline:none;box-sizing:border-box;margin-bottom:10px" placeholder="Projects/Cost Estimates"/><div style="display:flex;gap:8px"><button onclick="odSaveConfig()" style="background:#30363D;color:#E6EDF3;border:none;border-radius:6px;padding:8px 14px;font-weight:700;cursor:pointer;font-size:12px">Save</button><button onclick="odScan()" style="background:#F0A429;color:#000;border:none;border-radius:6px;padding:8px 18px;font-weight:700;cursor:pointer;font-size:12px;flex:1">&#9729; Scan OneDrive</button></div><div id="od-progress" style="display:none;padding:10px;background:#0D1117;border-radius:8px;border:1px solid #30363D;margin-top:10px"><div id="od-progress-msg" style="font-size:12px;margin-bottom:6px"></div><div style="background:#1C2128;border-radius:6px;height:6px"><div id="od-progress-bar" style="background:#F0A429;height:6px;border-radius:6px;width:0%;transition:width .3s"></div></div></div><div id="od-results" style="display:none;margin-top:10px"></div></div></div></div></div>
<button id="pwa-install-btn" onclick="installApp()" style="display:none;position:fixed;bottom:140px;right:24px;background:#10B981;color:#fff;border:none;border-radius:50%;width:44px;height:44px;font-size:20px;cursor:pointer;box-shadow:0 4px 16px #10B98166;z-index:199;align-items:center;justify-content:center;font-weight:700" title="Install App">+</button>
<button onclick="openODPanel()" style="position:fixed;bottom:80px;right:24px;background:#0078D4;color:#fff;border:none;border-radius:50%;width:44px;height:44px;font-size:18px;cursor:pointer;box-shadow:0 4px 16px #0078D466;z-index:199" title="Project Analyzer">&#128193;</button>
<button onclick="shicMLToggle()" style="position:fixed;bottom:24px;right:24px;background:#F0A429;color:#000;border:none;border-radius:50%;width:48px;height:48px;font-size:20px;cursor:pointer;box-shadow:0 4px 16px #F0A42966;z-index:199" title="ML Insights">&#129504;</button>
<script>
