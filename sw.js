...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=243',
  './vendor/react-dom.production.min.js?v=243',
  './vendor/xlsx.full.min.js?v=243',
  './vendor/pdf.min.js?v=243',
  './vendor/mammoth.browser.min.js?v=243',
  './src/constants.js?v=243',
  './src/helpers.js?v=243',
  './src/approval.js?v=243',
  './src/xlsx-styled.js?v=243',
  './src/ai.js?v=243',
  './src/ai_models.js?v=243',
  './src/config.js?v=243',
  './src/update.js?v=243',
  './src/sp.js?v=243',
  './src/idb.js?v=243',
  './src/db.js?v=243',
  './src/auth.js?v=243',
  './src/components/LoginPage.js?v=243',
  './src/components/RegisterPage.js?v=243',
  './src/components/CompanyDBPanel.js?v=243',
  './src/components/CeDefaultsPanel.js?v=243',
  './src/components/ShiftRatesPanel.js?v=243',
  './src/components/FbSetupPanel.js?v=243',
  './src/components/LocalToSPSync.js?v=243',
  './src/components/ChangePasswordModal.js?v=243',
  './src/components/UpdatePublisher.js?v=243',
  './src/components/AdminPanel.js?v=243',
  './src/components/ResTab.js?v=243',
  './src/App.js?v=243',
  './src/widgets.js?v=243',
  './src/tests.js?v=243',
  './src/ml_utils.js?v=243'
];
/* APP_END */
