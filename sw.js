...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=142',
  './vendor/react-dom.production.min.js?v=142',
  './vendor/xlsx.full.min.js?v=142',
  './vendor/pdf.min.js?v=142',
  './vendor/mammoth.browser.min.js?v=142',
  './src/constants.js?v=142',
  './src/helpers.js?v=142',
  './src/xlsx-styled.js?v=142',
  './src/ai.js?v=142',
  './src/ai_models.js?v=142',
  './src/config.js?v=142',
  './src/update.js?v=142',
  './src/sp.js?v=142',
  './src/idb.js?v=142',
  './src/db.js?v=142',
  './src/auth.js?v=142',
  './src/components/LoginPage.js?v=142',
  './src/components/RegisterPage.js?v=142',
  './src/components/CompanyDBPanel.js?v=142',
  './src/components/CeDefaultsPanel.js?v=142',
  './src/components/FbSetupPanel.js?v=142',
  './src/components/LocalToSPSync.js?v=142',
  './src/components/ChangePasswordModal.js?v=142',
  './src/components/UpdatePublisher.js?v=142',
  './src/components/AdminPanel.js?v=142',
  './src/components/ResTab.js?v=142',
  './src/App.js?v=142',
  './src/widgets.js?v=142',
  './src/tests.js?v=142',
  './src/ml_utils.js?v=142'
];
/* APP_END */
