...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=280',
  './vendor/react-dom.production.min.js?v=280',
  './vendor/xlsx.full.min.js?v=280',
  './vendor/pdf.min.js?v=280',
  './vendor/mammoth.browser.min.js?v=280',
  './src/constants.js?v=280',
  './src/helpers.js?v=280',
  './src/approval.js?v=280',
  './src/xlsx-styled.js?v=280',
  './src/ai.js?v=280',
  './src/ai_models.js?v=280',
  './src/config.js?v=280',
  './src/update.js?v=280',
  './src/qr.js?v=280',
  './src/sp.js?v=280',
  ...
  './src/db.js?v=280',
  './src/auth.js?v=280',
  './src/components/LoginPage.js?v=280',
  './src/components/RegisterPage.js?v=280',
  './src/components/CompanyDBPanel.js?v=280',
  './src/components/CeDefaultsPanel.js?v=280',
  './src/components/ShiftRatesPanel.js?v=280',
  './src/components/FbSetupPanel.js?v=280',
  './src/components/LocalToSPSync.js?v=280',
  './src/components/ChangePasswordModal.js?v=280',
  './src/components/UpdatePublisher.js?v=280',
  './src/components/AdminPanel.js?v=280',
  './src/components/RceChecklistCard.js?v=280',
  './src/components/ResTab.js?v=280',
  './src/App.js?v=280',
  './src/widgets.js?v=280',
  './src/tests.js?v=280',
  './src/ml_utils.js?v=280'
];
/* APP_END */
