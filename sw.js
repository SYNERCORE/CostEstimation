...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=94',
  './vendor/react-dom.production.min.js?v=94',
  './vendor/xlsx.full.min.js?v=94',
  './vendor/pdf.min.js?v=94',
  './vendor/mammoth.browser.min.js?v=94',
  './src/constants.js?v=94',
  './src/helpers.js?v=94',
  './src/xlsx-styled.js?v=94',
  './src/ai.js?v=94',
  './src/ai_models.js?v=94',
  './src/config.js?v=94',
  './src/update.js?v=94',
  './src/sp.js?v=94',
  './src/idb.js?v=94',
  './src/db.js?v=94',
  './src/auth.js?v=94',
  './src/components/LoginPage.js?v=94',
  './src/components/RegisterPage.js?v=94',
  './src/components/CompanyDBPanel.js?v=94',
  './src/components/CeDefaultsPanel.js?v=94',
  './src/components/FbSetupPanel.js?v=94',
  './src/components/LocalToSPSync.js?v=94',
  './src/components/ChangePasswordModal.js?v=94',
  './src/components/UpdatePublisher.js?v=94',
  './src/components/AdminPanel.js?v=94',
  './src/components/ResTab.js?v=94',
  './src/App.js?v=94',
  './src/widgets.js?v=94',
  './src/tests.js?v=94',
  './src/ml_utils.js?v=94'
];
/* APP_END */
