...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=165',
  './vendor/react-dom.production.min.js?v=165',
  './vendor/xlsx.full.min.js?v=165',
  './vendor/pdf.min.js?v=165',
  './vendor/mammoth.browser.min.js?v=165',
  './src/constants.js?v=165',
  './src/helpers.js?v=165',
  './src/xlsx-styled.js?v=165',
  './src/ai.js?v=165',
  './src/ai_models.js?v=165',
  './src/config.js?v=165',
  './src/update.js?v=165',
  './src/sp.js?v=165',
  './src/idb.js?v=165',
  './src/db.js?v=165',
  './src/auth.js?v=165',
  './src/components/LoginPage.js?v=165',
  './src/components/RegisterPage.js?v=165',
  './src/components/CompanyDBPanel.js?v=165',
  './src/components/CeDefaultsPanel.js?v=165',
  './src/components/FbSetupPanel.js?v=165',
  './src/components/LocalToSPSync.js?v=165',
  './src/components/ChangePasswordModal.js?v=165',
  './src/components/UpdatePublisher.js?v=165',
  './src/components/AdminPanel.js?v=165',
  './src/components/ResTab.js?v=165',
  './src/App.js?v=165',
  './src/widgets.js?v=165',
  './src/tests.js?v=165',
  './src/ml_utils.js?v=165'
];
/* APP_END */
