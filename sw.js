...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=163',
  './vendor/react-dom.production.min.js?v=163',
  './vendor/xlsx.full.min.js?v=163',
  './vendor/pdf.min.js?v=163',
  './vendor/mammoth.browser.min.js?v=163',
  './src/constants.js?v=163',
  './src/helpers.js?v=163',
  './src/xlsx-styled.js?v=163',
  './src/ai.js?v=163',
  './src/ai_models.js?v=163',
  './src/config.js?v=163',
  './src/update.js?v=163',
  './src/sp.js?v=163',
  './src/idb.js?v=163',
  './src/db.js?v=163',
  './src/auth.js?v=163',
  './src/components/LoginPage.js?v=163',
  './src/components/RegisterPage.js?v=163',
  './src/components/CompanyDBPanel.js?v=163',
  './src/components/CeDefaultsPanel.js?v=163',
  './src/components/FbSetupPanel.js?v=163',
  './src/components/LocalToSPSync.js?v=163',
  './src/components/ChangePasswordModal.js?v=163',
  './src/components/UpdatePublisher.js?v=163',
  './src/components/AdminPanel.js?v=163',
  './src/components/ResTab.js?v=163',
  './src/App.js?v=163',
  './src/widgets.js?v=163',
  './src/tests.js?v=163',
  './src/ml_utils.js?v=163'
];
/* APP_END */
