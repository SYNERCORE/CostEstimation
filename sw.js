...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=198',
  './vendor/react-dom.production.min.js?v=198',
  './vendor/xlsx.full.min.js?v=198',
  './vendor/pdf.min.js?v=198',
  './vendor/mammoth.browser.min.js?v=198',
  './src/constants.js?v=198',
  './src/helpers.js?v=198',
  './src/xlsx-styled.js?v=198',
  './src/ai.js?v=198',
  './src/ai_models.js?v=198',
  './src/config.js?v=198',
  './src/update.js?v=198',
  './src/sp.js?v=198',
  './src/idb.js?v=198',
  './src/db.js?v=198',
  './src/auth.js?v=198',
  './src/components/LoginPage.js?v=198',
  './src/components/RegisterPage.js?v=198',
  './src/components/CompanyDBPanel.js?v=198',
  './src/components/CeDefaultsPanel.js?v=198',
  './src/components/ShiftRatesPanel.js?v=198',
  './src/components/FbSetupPanel.js?v=198',
  './src/components/LocalToSPSync.js?v=198',
  './src/components/ChangePasswordModal.js?v=198',
  './src/components/UpdatePublisher.js?v=198',
  './src/components/AdminPanel.js?v=198',
  './src/components/ResTab.js?v=198',
  './src/App.js?v=198',
  './src/widgets.js?v=198',
  './src/tests.js?v=198',
  './src/ml_utils.js?v=198'
];
/* APP_END */
