...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=135',
  './vendor/react-dom.production.min.js?v=135',
  './vendor/xlsx.full.min.js?v=135',
  './vendor/pdf.min.js?v=135',
  './vendor/mammoth.browser.min.js?v=135',
  './src/constants.js?v=135',
  './src/helpers.js?v=135',
  './src/xlsx-styled.js?v=135',
  './src/ai.js?v=135',
  './src/ai_models.js?v=135',
  './src/config.js?v=135',
  './src/update.js?v=135',
  './src/sp.js?v=135',
  './src/idb.js?v=135',
  './src/db.js?v=135',
  './src/auth.js?v=135',
  './src/components/LoginPage.js?v=135',
  './src/components/RegisterPage.js?v=135',
  './src/components/CompanyDBPanel.js?v=135',
  './src/components/CeDefaultsPanel.js?v=135',
  './src/components/FbSetupPanel.js?v=135',
  './src/components/LocalToSPSync.js?v=135',
  './src/components/ChangePasswordModal.js?v=135',
  './src/components/UpdatePublisher.js?v=135',
  './src/components/AdminPanel.js?v=135',
  './src/components/ResTab.js?v=135',
  './src/App.js?v=135',
  './src/widgets.js?v=135',
  './src/tests.js?v=135',
  './src/ml_utils.js?v=135'
];
/* APP_END */
