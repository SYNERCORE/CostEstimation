...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=223',
  './vendor/react-dom.production.min.js?v=223',
  './vendor/xlsx.full.min.js?v=223',
  './vendor/pdf.min.js?v=223',
  './vendor/mammoth.browser.min.js?v=223',
  './src/constants.js?v=223',
  './src/helpers.js?v=223',
  './src/approval.js?v=223',
  './src/xlsx-styled.js?v=223',
  './src/ai.js?v=223',
  './src/ai_models.js?v=223',
  './src/config.js?v=223',
  './src/update.js?v=223',
  './src/sp.js?v=223',
  './src/idb.js?v=223',
  './src/db.js?v=223',
  './src/auth.js?v=223',
  './src/components/LoginPage.js?v=223',
  './src/components/RegisterPage.js?v=223',
  './src/components/CompanyDBPanel.js?v=223',
  './src/components/CeDefaultsPanel.js?v=223',
  './src/components/ShiftRatesPanel.js?v=223',
  './src/components/FbSetupPanel.js?v=223',
  './src/components/LocalToSPSync.js?v=223',
  './src/components/ChangePasswordModal.js?v=223',
  './src/components/UpdatePublisher.js?v=223',
  './src/components/AdminPanel.js?v=223',
  './src/components/ResTab.js?v=223',
  './src/App.js?v=223',
  './src/widgets.js?v=223',
  './src/tests.js?v=223',
  './src/ml_utils.js?v=223'
];
/* APP_END */
