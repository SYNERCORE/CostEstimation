...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=281',
  './vendor/react-dom.production.min.js?v=281',
  './vendor/xlsx.full.min.js?v=281',
  './vendor/pdf.min.js?v=281',
  './vendor/mammoth.browser.min.js?v=281',
  './src/constants.js?v=281',
  './src/helpers.js?v=281',
  './src/approval.js?v=281',
  './src/xlsx-styled.js?v=281',
  './src/ai.js?v=281',
  './src/ai_models.js?v=281',
  './src/config.js?v=281',
  './src/update.js?v=281',
  './src/qr.js?v=281',
  './src/sp.js?v=281',
  ...
  './src/db.js?v=281',
  './src/auth.js?v=281',
  './src/components/LoginPage.js?v=281',
  './src/components/RegisterPage.js?v=281',
  './src/components/CompanyDBPanel.js?v=281',
  './src/components/CeDefaultsPanel.js?v=281',
  './src/components/ShiftRatesPanel.js?v=281',
  './src/components/FbSetupPanel.js?v=281',
  './src/components/LocalToSPSync.js?v=281',
  './src/components/ChangePasswordModal.js?v=281',
  './src/components/UpdatePublisher.js?v=281',
  './src/components/AdminPanel.js?v=281',
  './src/components/RceChecklistCard.js?v=281',
  './src/components/ResTab.js?v=281',
  './src/App.js?v=281',
  './src/widgets.js?v=281',
  './src/tests.js?v=281',
  './src/ml_utils.js?v=281'
];
/* APP_END */
