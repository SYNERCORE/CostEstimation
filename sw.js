...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=189',
  './vendor/react-dom.production.min.js?v=189',
  './vendor/xlsx.full.min.js?v=189',
  './vendor/pdf.min.js?v=189',
  './vendor/mammoth.browser.min.js?v=189',
  './src/constants.js?v=189',
  './src/helpers.js?v=189',
  './src/xlsx-styled.js?v=189',
  './src/ai.js?v=189',
  './src/ai_models.js?v=189',
  './src/config.js?v=189',
  './src/update.js?v=189',
  './src/sp.js?v=189',
  './src/idb.js?v=189',
  './src/db.js?v=189',
  './src/auth.js?v=189',
  './src/components/LoginPage.js?v=189',
  './src/components/RegisterPage.js?v=189',
  './src/components/CompanyDBPanel.js?v=189',
  './src/components/CeDefaultsPanel.js?v=189',
  './src/components/ShiftRatesPanel.js?v=189',
  './src/components/FbSetupPanel.js?v=189',
  './src/components/LocalToSPSync.js?v=189',
  './src/components/ChangePasswordModal.js?v=189',
  './src/components/UpdatePublisher.js?v=189',
  './src/components/AdminPanel.js?v=189',
  './src/components/ResTab.js?v=189',
  './src/App.js?v=189',
  './src/widgets.js?v=189',
  './src/tests.js?v=189',
  './src/ml_utils.js?v=189'
];
/* APP_END */
