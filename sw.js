...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=276',
  './vendor/react-dom.production.min.js?v=276',
  './vendor/xlsx.full.min.js?v=276',
  './vendor/pdf.min.js?v=276',
  './vendor/mammoth.browser.min.js?v=276',
  './src/constants.js?v=276',
  './src/helpers.js?v=276',
  './src/approval.js?v=276',
  './src/xlsx-styled.js?v=276',
  './src/ai.js?v=276',
  './src/ai_models.js?v=276',
  './src/config.js?v=276',
  './src/update.js?v=276',
  './src/qr.js?v=276',
  './src/sp.js?v=276',
  ...
  './src/db.js?v=276',
  './src/auth.js?v=276',
  './src/components/LoginPage.js?v=276',
  './src/components/RegisterPage.js?v=276',
  './src/components/CompanyDBPanel.js?v=276',
  './src/components/CeDefaultsPanel.js?v=276',
  './src/components/ShiftRatesPanel.js?v=276',
  './src/components/FbSetupPanel.js?v=276',
  './src/components/LocalToSPSync.js?v=276',
  './src/components/ChangePasswordModal.js?v=276',
  './src/components/UpdatePublisher.js?v=276',
  './src/components/AdminPanel.js?v=276',
  './src/components/RceChecklistCard.js?v=276',
  './src/components/ResTab.js?v=276',
  './src/App.js?v=276',
  './src/widgets.js?v=276',
  './src/tests.js?v=276',
  './src/ml_utils.js?v=276'
];
/* APP_END */
