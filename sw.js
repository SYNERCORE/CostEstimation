...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=282',
  './vendor/react-dom.production.min.js?v=282',
  './vendor/xlsx.full.min.js?v=282',
  './vendor/pdf.min.js?v=282',
  './vendor/mammoth.browser.min.js?v=282',
  './src/constants.js?v=282',
  './src/helpers.js?v=282',
  './src/approval.js?v=282',
  './src/xlsx-styled.js?v=282',
  './src/ai.js?v=282',
  './src/ai_models.js?v=282',
  './src/config.js?v=282',
  './src/update.js?v=282',
  './src/qr.js?v=282',
  './src/sp.js?v=282',
  ...
  './src/db.js?v=282',
  './src/auth.js?v=282',
  './src/components/LoginPage.js?v=282',
  './src/components/RegisterPage.js?v=282',
  './src/components/CompanyDBPanel.js?v=282',
  './src/components/CeDefaultsPanel.js?v=282',
  './src/components/ShiftRatesPanel.js?v=282',
  './src/components/FbSetupPanel.js?v=282',
  './src/components/LocalToSPSync.js?v=282',
  './src/components/ChangePasswordModal.js?v=282',
  './src/components/UpdatePublisher.js?v=282',
  './src/components/AdminPanel.js?v=282',
  './src/components/RceChecklistCard.js?v=282',
  './src/components/ResTab.js?v=282',
  './src/App.js?v=282',
  './src/widgets.js?v=282',
  './src/tests.js?v=282',
  './src/ml_utils.js?v=282'
];
/* APP_END */
