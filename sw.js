...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=238',
  './vendor/react-dom.production.min.js?v=238',
  './vendor/xlsx.full.min.js?v=238',
  './vendor/pdf.min.js?v=238',
  './vendor/mammoth.browser.min.js?v=238',
  './src/constants.js?v=238',
  './src/helpers.js?v=238',
  './src/approval.js?v=238',
  './src/xlsx-styled.js?v=238',
  './src/ai.js?v=238',
  './src/ai_models.js?v=238',
  './src/config.js?v=238',
  './src/update.js?v=238',
  './src/sp.js?v=238',
  './src/idb.js?v=238',
  './src/db.js?v=238',
  './src/auth.js?v=238',
  './src/components/LoginPage.js?v=238',
  './src/components/RegisterPage.js?v=238',
  './src/components/CompanyDBPanel.js?v=238',
  './src/components/CeDefaultsPanel.js?v=238',
  './src/components/ShiftRatesPanel.js?v=238',
  './src/components/FbSetupPanel.js?v=238',
  './src/components/LocalToSPSync.js?v=238',
  './src/components/ChangePasswordModal.js?v=238',
  './src/components/UpdatePublisher.js?v=238',
  './src/components/AdminPanel.js?v=238',
  './src/components/ResTab.js?v=238',
  './src/App.js?v=238',
  './src/widgets.js?v=238',
  './src/tests.js?v=238',
  './src/ml_utils.js?v=238'
];
/* APP_END */
