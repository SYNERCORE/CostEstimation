...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=109',
  './vendor/react-dom.production.min.js?v=109',
  './vendor/xlsx.full.min.js?v=109',
  './vendor/pdf.min.js?v=109',
  './vendor/mammoth.browser.min.js?v=109',
  './src/constants.js?v=109',
  './src/helpers.js?v=109',
  './src/xlsx-styled.js?v=109',
  './src/ai.js?v=109',
  './src/ai_models.js?v=109',
  './src/config.js?v=109',
  './src/update.js?v=109',
  './src/sp.js?v=109',
  './src/idb.js?v=109',
  './src/db.js?v=109',
  './src/auth.js?v=109',
  './src/components/LoginPage.js?v=109',
  './src/components/RegisterPage.js?v=109',
  './src/components/CompanyDBPanel.js?v=109',
  './src/components/CeDefaultsPanel.js?v=109',
  './src/components/FbSetupPanel.js?v=109',
  './src/components/LocalToSPSync.js?v=109',
  './src/components/ChangePasswordModal.js?v=109',
  './src/components/UpdatePublisher.js?v=109',
  './src/components/AdminPanel.js?v=109',
  './src/components/ResTab.js?v=109',
  './src/App.js?v=109',
  './src/widgets.js?v=109',
  './src/tests.js?v=109',
  './src/ml_utils.js?v=109'
];
/* APP_END */
