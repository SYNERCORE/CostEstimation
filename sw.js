...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=91',
  './vendor/react-dom.production.min.js?v=91',
  './vendor/xlsx.full.min.js?v=91',
  './vendor/pdf.min.js?v=91',
  './vendor/mammoth.browser.min.js?v=91',
  './src/constants.js?v=91',
  './src/helpers.js?v=91',
  './src/xlsx-styled.js?v=91',
  './src/ai.js?v=91',
  './src/ai_models.js?v=91',
  './src/config.js?v=91',
  './src/update.js?v=91',
  './src/sp.js?v=91',
  './src/idb.js?v=91',
  './src/db.js?v=91',
  './src/auth.js?v=91',
  './src/components/LoginPage.js?v=91',
  './src/components/RegisterPage.js?v=91',
  './src/components/CompanyDBPanel.js?v=91',
  './src/components/CeDefaultsPanel.js?v=91',
  './src/components/FbSetupPanel.js?v=91',
  './src/components/LocalToSPSync.js?v=91',
  './src/components/ChangePasswordModal.js?v=91',
  './src/components/UpdatePublisher.js?v=91',
  './src/components/AdminPanel.js?v=91',
  './src/components/ResTab.js?v=91',
  './src/App.js?v=91',
  './src/widgets.js?v=91',
  './src/tests.js?v=91',
  './src/ml_utils.js?v=91'
];
/* APP_END */
