...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=277',
  './vendor/react-dom.production.min.js?v=277',
  './vendor/xlsx.full.min.js?v=277',
  './vendor/pdf.min.js?v=277',
  './vendor/mammoth.browser.min.js?v=277',
  './src/constants.js?v=277',
  './src/helpers.js?v=277',
  './src/approval.js?v=277',
  './src/xlsx-styled.js?v=277',
  './src/ai.js?v=277',
  './src/ai_models.js?v=277',
  './src/config.js?v=277',
  './src/update.js?v=277',
  './src/qr.js?v=277',
  './src/sp.js?v=277',
  ...
  './src/db.js?v=277',
  './src/auth.js?v=277',
  './src/components/LoginPage.js?v=277',
  './src/components/RegisterPage.js?v=277',
  './src/components/CompanyDBPanel.js?v=277',
  './src/components/CeDefaultsPanel.js?v=277',
  './src/components/ShiftRatesPanel.js?v=277',
  './src/components/FbSetupPanel.js?v=277',
  './src/components/LocalToSPSync.js?v=277',
  './src/components/ChangePasswordModal.js?v=277',
  './src/components/UpdatePublisher.js?v=277',
  './src/components/AdminPanel.js?v=277',
  './src/components/RceChecklistCard.js?v=277',
  './src/components/ResTab.js?v=277',
  './src/App.js?v=277',
  './src/widgets.js?v=277',
  './src/tests.js?v=277',
  './src/ml_utils.js?v=277'
];
/* APP_END */
