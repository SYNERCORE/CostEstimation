...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=138',
  './vendor/react-dom.production.min.js?v=138',
  './vendor/xlsx.full.min.js?v=138',
  './vendor/pdf.min.js?v=138',
  './vendor/mammoth.browser.min.js?v=138',
  './src/constants.js?v=138',
  './src/helpers.js?v=138',
  './src/xlsx-styled.js?v=138',
  './src/ai.js?v=138',
  './src/ai_models.js?v=138',
  './src/config.js?v=138',
  './src/update.js?v=138',
  './src/sp.js?v=138',
  './src/idb.js?v=138',
  './src/db.js?v=138',
  './src/auth.js?v=138',
  './src/components/LoginPage.js?v=138',
  './src/components/RegisterPage.js?v=138',
  './src/components/CompanyDBPanel.js?v=138',
  './src/components/CeDefaultsPanel.js?v=138',
  './src/components/FbSetupPanel.js?v=138',
  './src/components/LocalToSPSync.js?v=138',
  './src/components/ChangePasswordModal.js?v=138',
  './src/components/UpdatePublisher.js?v=138',
  './src/components/AdminPanel.js?v=138',
  './src/components/ResTab.js?v=138',
  './src/App.js?v=138',
  './src/widgets.js?v=138',
  './src/tests.js?v=138',
  './src/ml_utils.js?v=138'
];
/* APP_END */
