...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=194',
  './vendor/react-dom.production.min.js?v=194',
  './vendor/xlsx.full.min.js?v=194',
  './vendor/pdf.min.js?v=194',
  './vendor/mammoth.browser.min.js?v=194',
  './src/constants.js?v=194',
  './src/helpers.js?v=194',
  './src/xlsx-styled.js?v=194',
  './src/ai.js?v=194',
  './src/ai_models.js?v=194',
  './src/config.js?v=194',
  './src/update.js?v=194',
  './src/sp.js?v=194',
  './src/idb.js?v=194',
  './src/db.js?v=194',
  './src/auth.js?v=194',
  './src/components/LoginPage.js?v=194',
  './src/components/RegisterPage.js?v=194',
  './src/components/CompanyDBPanel.js?v=194',
  './src/components/CeDefaultsPanel.js?v=194',
  './src/components/ShiftRatesPanel.js?v=194',
  './src/components/FbSetupPanel.js?v=194',
  './src/components/LocalToSPSync.js?v=194',
  './src/components/ChangePasswordModal.js?v=194',
  './src/components/UpdatePublisher.js?v=194',
  './src/components/AdminPanel.js?v=194',
  './src/components/ResTab.js?v=194',
  './src/App.js?v=194',
  './src/widgets.js?v=194',
  './src/tests.js?v=194',
  './src/ml_utils.js?v=194'
];
/* APP_END */
