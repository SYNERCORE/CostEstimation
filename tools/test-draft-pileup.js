...
const hist = [
  { ceNum: 'SY3-CE-2026-1129-R7', savedAt: '2026-09-23T05:00:00Z' },
  { info: { ceNum: 'SY3-CE-2026-1059' }, savedAt: '2026-09-23T02:00:00Z' }
];
const drafts = [
...
ck("a draft written before its CE was saved is cleared, whoever wrote it", done.includes('a'));
...
ck('a lower-case or spaced CE number still matches', run(
  [{ draftId: 'e', savedAt: '2026-09-23T04:00:00Z', info: { ceNum: ' sy3-ce-2026-1129-r7 ' } }], hist).length === 1);
