...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=188',
  './vendor/react-dom.production.min.js?v=188',
  './vendor/xlsx.full.min.js?v=188',
  './vendor/pdf.min.js?v=188',
  './vendor/mammoth.browser.min.js?v=188',
  './src/constants.js?v=188',
  './src/helpers.js?v=188',
  './src/xlsx-styled.js?v=188',
  './src/ai.js?v=188',
  './src/ai_models.js?v=188',
  './src/config.js?v=188',
  './src/update.js?v=188',
  './src/sp.js?v=188',
  './src/idb.js?v=188',
  './src/db.js?v=188',
  './src/auth.js?v=188',
  './src/components/LoginPage.js?v=188',
  './src/components/RegisterPage.js?v=188',
  './src/components/CompanyDBPanel.js?v=188',
  './src/components/CeDefaultsPanel.js?v=188',
  './src/components/ShiftRatesPanel.js?v=188',
  './src/components/FbSetupPanel.js?v=188',
  './src/components/LocalToSPSync.js?v=188',
  './src/components/ChangePasswordModal.js?v=188',
  './src/components/UpdatePublisher.js?v=188',
  './src/components/AdminPanel.js?v=188',
  './src/components/ResTab.js?v=188',
  './src/App.js?v=188',
  './src/widgets.js?v=188',
  './src/tests.js?v=188',
  './src/ml_utils.js?v=188'
];
/* APP_END */
