...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=190',
  './vendor/react-dom.production.min.js?v=190',
  './vendor/xlsx.full.min.js?v=190',
  './vendor/pdf.min.js?v=190',
  './vendor/mammoth.browser.min.js?v=190',
  './src/constants.js?v=190',
  './src/helpers.js?v=190',
  './src/xlsx-styled.js?v=190',
  './src/ai.js?v=190',
  './src/ai_models.js?v=190',
  './src/config.js?v=190',
  './src/update.js?v=190',
  './src/sp.js?v=190',
  './src/idb.js?v=190',
  './src/db.js?v=190',
  './src/auth.js?v=190',
  './src/components/LoginPage.js?v=190',
  './src/components/RegisterPage.js?v=190',
  './src/components/CompanyDBPanel.js?v=190',
  './src/components/CeDefaultsPanel.js?v=190',
  './src/components/ShiftRatesPanel.js?v=190',
  './src/components/FbSetupPanel.js?v=190',
  './src/components/LocalToSPSync.js?v=190',
  './src/components/ChangePasswordModal.js?v=190',
  './src/components/UpdatePublisher.js?v=190',
  './src/components/AdminPanel.js?v=190',
  './src/components/ResTab.js?v=190',
  './src/App.js?v=190',
  './src/widgets.js?v=190',
  './src/tests.js?v=190',
  './src/ml_utils.js?v=190'
];
/* APP_END */
