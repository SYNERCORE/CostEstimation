...
const CE_TABS=[{id:"info",label:"Project Info"},{id:"sow",label:"Scope of Work"},{id:"manpower",label:"Manpower"},{id:"tools",label:"Tools & Equip"},{id:"materials",label:"Materials"},{id:"ppe",label:"PPE"},{id:"misc",label:"Miscellaneous"},{id:"summary",label:"Summary"},{id:"scopelib",label:"Scope Library"},{id:"masterlist",label:"Masterlist"},{id:"history",label:"CE Monitoring"},{id:"dashboard",label:"📊 Dashboard"}];
const DEFAULT_ML={
  manpower:[
