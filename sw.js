...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=95',
  './vendor/react-dom.production.min.js?v=95',
  './vendor/xlsx.full.min.js?v=95',
  './vendor/pdf.min.js?v=95',
  './vendor/mammoth.browser.min.js?v=95',
  './src/constants.js?v=95',
  './src/helpers.js?v=95',
  './src/xlsx-styled.js?v=95',
  './src/ai.js?v=95',
  './src/ai_models.js?v=95',
  './src/config.js?v=95',
  './src/update.js?v=95',
  './src/sp.js?v=95',
  './src/idb.js?v=95',
  './src/db.js?v=95',
  './src/auth.js?v=95',
  './src/components/LoginPage.js?v=95',
  './src/components/RegisterPage.js?v=95',
  './src/components/CompanyDBPanel.js?v=95',
  './src/components/CeDefaultsPanel.js?v=95',
  './src/components/FbSetupPanel.js?v=95',
  './src/components/LocalToSPSync.js?v=95',
  './src/components/ChangePasswordModal.js?v=95',
  './src/components/UpdatePublisher.js?v=95',
  './src/components/AdminPanel.js?v=95',
  './src/components/ResTab.js?v=95',
  './src/App.js?v=95',
  './src/widgets.js?v=95',
  './src/tests.js?v=95',
  './src/ml_utils.js?v=95'
];
/* APP_END */
