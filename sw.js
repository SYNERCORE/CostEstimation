...
/* Every application script index.html loads, with the same ?v= query it uses.
   ...
   APP_START */
const APP=[
  './vendor/react.production.min.js?v=82',
  './vendor/react-dom.production.min.js?v=82',
  './vendor/xlsx.full.min.js?v=82',
  './vendor/pdf.min.js?v=82',
  './vendor/mammoth.browser.min.js?v=82',
  './src/constants.js?v=82',
  './src/helpers.js?v=82',
  './src/xlsx-styled.js?v=82',
  './src/ai.js?v=82',
  './src/ai_models.js?v=82',
  './src/config.js?v=82',
  './src/update.js?v=82',
  './src/sp.js?v=82',
  './src/idb.js?v=82',
  './src/db.js?v=82',
  './src/auth.js?v=82',
  './src/components/LoginPage.js?v=82',
  './src/components/RegisterPage.js?v=82',
  './src/components/CompanyDBPanel.js?v=82',
  './src/components/FbSetupPanel.js?v=82',
  './src/components/LocalToSPSync.js?v=82',
  './src/components/ChangePasswordModal.js?v=82',
  './src/components/UpdatePublisher.js?v=82',
  './src/components/AdminPanel.js?v=82',
  './src/components/ResTab.js?v=82',
  './src/App.js?v=82',
  './src/widgets.js?v=82',
  './src/tests.js?v=82',
  './src/ml_utils.js?v=82'
];
/* APP_END */
